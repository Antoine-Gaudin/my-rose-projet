...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urlpdf: Schema.Attribute.Text;
    urlphoto: Schema.Attribute.Text;
  };
}
...
export interface ApiCategorieCategorie extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    souscategories: Schema.Attribute.Relation<
      'manyToMany',
      'api::souscategorie.souscategorie'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    urlfond: Schema.Attribute.Text;
  };
}
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lettre: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::menu.menu'> &
      Schema.Attribute.Private;
    nameattribution: Schema.Attribute.Text;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::souscategorie.souscategorie': ApiSouscategorieSouscategorie;
